...
<br/>
<br>
<h1>Welcome, <?php echo $_SESSION['current_session']['user']['last_name'] . ' ' . $_SESSION['current_session']['user']['first_name']; ?></h1>

<!-- First Grid -->
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-twothird">
      <h1>Welcome To Marion's Car Inventory</h1>
      <h5 class="w3-padding-32">This system's purpose is to act as a record keeps of car information in Marion's Auto Shop.</h5>

      <p class="w3-text-grey">Click the buttons on the navbar to navigate around but please don't forget to logout.</p>
    </div>
